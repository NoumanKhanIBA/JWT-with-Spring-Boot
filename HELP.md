...
* The original package name 'com.example.JWT Authentication using Spring Boot' is invalid and this project uses 'com.example.JWT.Authentication.using.Spring.Boot' instead.
